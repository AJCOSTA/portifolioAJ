...
export default function Home({ targetSection, language = "pt" }: HomeProps) {
  ...
  const content = {
    ...
    en: {
      heroBadge: "Senior Python Consultant & IT Manager",
      heroTitlePrefix: "Scalable",
      heroTitleHighlight: "Solutions",
      heroTitleSuffix: "for Growth",
      heroSubtitle:
        "Architecting digital products that reduce operational costs, scale effortlessly, and generate real ROI for your operation. 13+ years turning tech bottlenecks into strategic advantages.",
      heroCtaPrimary: "Start a Project",
      heroCtaSecondary: "View Solutions",
      heroFloatLeft: "Cloud Native",
      heroFloatRight: "High-Traffic APIs",
      aboutTitle: "Why Hire Me?",
      aboutFloat: "ROI & Scale",
      aboutParagraphs: [
        "With over 13 years blending Software Engineering and IT Leadership, my focus goes beyond writing code—I architect digital products that heavily reduce operational costs, scale without friction, and generate a real return on investment.",
        "Unlike a traditional developer, acting as an IT Coordinator gave me deep visibility into the full lifecycle of corporate products: from designing Cloud Native ecosystems (AWS, Docker, DevOps) and ultra-concurrent Python APIs to mission-critical integrations."
      ],
      profileTitle: "The Problem-Solver Profile",
      profileParagraphs: [
        "My premise is clear: technology must serve the business. Combining a strong foundation in Python, Software Architecture, and DevOps, I take full ownership of tough projects so technical bottlenecks never slow down your sales.",
        "Absolute mastery in extracting complex data, refactoring monolithic legacies into microservices, and applying AI/Machine Learning (OpenCV, PyTorch) in scenarios where the market demands aggressive innovation.",
        "Direct communication, vendor management, and agile leadership qualify me as the perfect bridge between Board-level goals and the actual code running on the servers."
      ],
      qualitiesTitle: "B2B Corporate Advantages",
      qualitiesFloat: "Business Focus",
      qualitiesList: [
        "Building architectures prepared for massive traffic scales",
        "Expert in modernizing legacy platforms and monoliths",
        "Drastic reduction of Cloud costs via fine-tuned DevOps practices",
        "End-to-end vision: from complex databases (Oracle/Postgres) to frontend",
        "Strict implementation of automated routines and security policies",
        "Superior ability to translate 'tech jargon' into C-Level milestones",
        "Deliveries focused on immediate efficiency spikes for the client's team"
      ],
      areasTitle: "Solutions I Can Develop For You",
      ...
      objectiveTitle: "Take Your Software to the Next Level",
      objectiveFloat: "Seniority & Impact",
      objectiveText:
        "Looking to get your platform off the ground or modernize a problematic legacy? My mission is to deliver robust solutions that won't break on a Friday. When working with me, we design technical efficiency tied to real business results.",
      contactTitle: "Let's Start Your Project?",
      contactTag: "Open for Consulting / Freelance",
      contactSubtitle:
        "Need a Senior Python Consultant or a Tech Lead? Leave your proposal below or reach out via my direct channels. I respond in less than 24 hours.",
